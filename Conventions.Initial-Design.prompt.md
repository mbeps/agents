...
- Write to File: Save to .github/instructions/conventions.instructions.md using template from Conventions agent
...
- Final Destination: .github/instructions/conventions.instructions.md

## Documentation Standards
- Follow the Documentation Standards block in Conventions.Analyse-Codebase.prompt.md (80-line cap, bullets only, density rules)
